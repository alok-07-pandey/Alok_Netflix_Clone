...
// import { clearTeaserMovie } from '../redux/movieSlice';
...
//       dispatch(clearTeaserMovie());     // Clear trailer video
...
//           <h1 className='text-lg font-medium text-white ml-1'>{user.fullName}</h1>
